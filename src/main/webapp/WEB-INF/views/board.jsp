...
<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %> <!--jstl때문에 버전 오류가 생김 core_rt쓰면 해결됨-->
<%@ page session="true"%>
...
<div class="container">
    ...
    <form id="form" class="frm" action="" method="post">
        ...
        <c:if test="${mode ne 'new'}">
            ...
            <button type="button" id="writeComment" class="btn btn-write"><i class="fa fa-pencil"></i> 댓글쓰기</button>
        </c:if>
...
<script>
    $(document).ready(function(){
        ...
        $("#writeComment").on("click", function(){
            location.href="<c:url value='/board/commentsTest?bno=${boardDto.bno}'/>";
        });
